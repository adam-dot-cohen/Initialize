...
public class ListExperimentBenchmarks
{
    private Mapper _autoMapper;
    private List<Test> _testEnumerable;

    public ListExperimentBenchmarks()
    {
        //Initialize mapper
    ...
    public void Setup()
    {
        _testEnumerable = Enumerable.Range(0, Iterations)
            .Select(r => new Test() { PropString = r.ToString(), Prop = r }).ToList();
